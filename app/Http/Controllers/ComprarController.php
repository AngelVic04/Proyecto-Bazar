...
class ComprarController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request)
        {
            ...
            ->orderBy('id','desc')
            ->paginate(7);
            return view('comprar.index',["perritos"=>$perritos,"searchText"=>$query]);
        }
    }
    ...
    {
        return view("comprar.show",["perrito"=>Venta::findOrFail($id)]);
    }
    ...
    {
        return view("comprar.edit",["perrito"=>Venta::findOrFail($id)]); 
    }

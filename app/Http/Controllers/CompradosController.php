...
class CompradosController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request)
        {
            ...
            ->orderBy('id','desc')
            ->paginate(7);
            return view('comprados.index',["perritos"=>$perritos,"searchText"=>$query]);
        }
    }
    ...
    public function create()
    {
        ...
        $personas = User::all();
        return view('comprados.create', compact('pericos','personas'));
    }
    ...
    {
        return view("comprados.show",["perrito"=>Venta::findOrFail($id)]);
    }
    ...
    {
        return view("comprados.edit",["perrito"=>Venta::findOrFail($id)]); 
    }
